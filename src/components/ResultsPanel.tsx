  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 space-y-4">
      ...
      <div className="text-xs text-gray-400 text-left pt-2">
        预期总计算用时评估基准：单核 4,500,000 点 × 1000 步 = 1,500 s，其中单核分配 4,500,000 个网格点时需使用约 1.42 GB 内存。该基准由 2025 年 11 月于华为云 kC2 实例（CPU 型号为 HUAWEI Kunpeng 920）运行的基准测试得到。总用时包含并行效率因子。需计算平台支持 100 Gbps 及以上的节点间带宽。受计算平台硬件架构和网络拓扑结构的影响，实际运行时间可能更长。本估算不构成性能保证，亦不作为验收指标。
      </div>
    </div>
  );
}
